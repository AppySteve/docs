...
<AccordionGroup>
  <Accordion title="Build" icon="hammer" iconType="regular">
    **Turn Expertise Into AI**
    ...
    - **Advanced Capabilities**: Your agents can browse the web, send emails, create documents and spreadsheets, store data, and integrate with other services - all configured through simple settings. Ask your agent to put together a monthly sales report as a spreadsheet, draft a proposal, or organize data - it handles the details while you focus on your business.
  ...
  <Accordion title="Promote" icon="arrow-down-to-arc">
