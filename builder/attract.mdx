---
title: "Attract"
description: "Once you've set up pricing, completed Stripe authorization, and published your agent - you can start attracting customers to your agent with shareable links. This is where you'll get the URLs to promote your agent and drive signups."
---
...
<Note>
  Change your subdomain by clicking your organization name in the upper right, then 'Manage', then 'Update Profile', then 'Slug'
</Note>
