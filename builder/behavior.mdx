...
<iframe className="w-full aspect-video rounded-xl" src="https://www.youtube.com/embed/rC5fvI_biak?rel=0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
Within your instructions, you can @mention [preferences](/builder/preferences) or [databases](/builder/databases) you have created, as well as system variables like your customer's name or email address. Add these to your instructions to help your agent know precisely how to utilize these variables.
...
<iframe className="w-full aspect-video rounded-xl" src="https://www.youtube.com/embed/wTYzzpRSo6M?rel=0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
