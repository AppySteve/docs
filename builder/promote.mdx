...
<img
  src="/images/Screenshot2025-07-23at12.21.14PM.png"
  alt="Screenshot 2025-07-23 at 12.21.14 PM"
  title="Screenshot 2025-07-23 at 12.21.14 PM"
  style={{ width:"100%" }}
/>

### Changing your subdomain

1. Navigate to your agent's **Settings** tab in the builder
2. Update the **Agent Subdomain** field to your desired subdomain
3. Save your changes

## Links to Share Your Agent

AppyAI provides you with ready-to-use links that you can easily share to start getting customers.

![Screenshot2025 07 23at12 21 57PM Pn](/images/Screenshot2025-07-23at12.21.57PM.png)
...
2. **Publish** your agent via the button next to "Preview"
