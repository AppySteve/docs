...
<img
  src="/images/Screenshot2025-12-09at3.27.07PM.png"
  alt="Screenshot 2025-12-09 at 3.27.07 PM.png"
  title="Screenshot 2025-12-09 at 3.27.07 PM.png"
  style={{ width:"57%" }}
/>
...
- **Agent Subdomain -** modify the URL where your published agent will be hosted ([SUBDOMAIN].appy.ai)
...
Ask Violet to set up settings:

- "Change the name of my agent"
- "Change my agent website to..."
- "Turn on team invites"

Violet creates the settings and updates your agent.

## Configure Manually

Access preferences directly through **Settings.**

## **Getting Started**

2. Review your brand settings and how it relates to your agent
