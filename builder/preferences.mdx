...
<iframe className="w-full aspect-video rounded-xl" src="https://www.youtube.com/embed/ptp-MsH7a0I?rel=0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
4. **Update your agent's instructions** to reference the preferences data (the word _settings_ in double curly brackets)
