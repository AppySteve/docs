...
Include a simple tag in your agent's behavior so that it knows to reference these preferences.\
Type @ and use the dropdown list or click the curly brackets in the text editor. \
\
**Add @User Preferences for the agent to reference all preferences.**

<img
  src="/images/Screenshot2025-09-29at9.09.07AM.png"
  alt="Screenshot 2025-09-29 at 9.09.07 AM.png"
  title="Screenshot 2025-09-29 at 9.09.07 AM.png"
  style={{ width:"65%" }}
/>

**Select at specific preference to more narrowly focus**

<img
  src="/images/Screenshot2025-09-29at9.15.43AM.png"
  alt="Screenshot 2025-09-29 at 9.15.43 AM.png"
  title="Screenshot 2025-09-29 at 9.15.43 AM.png"
  style={{ width:"79%" }}
/>
