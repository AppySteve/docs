...
<img
  src="/images/Screenshot2025-06-12at4.38.53PM.png"
  alt="Screenshot2025 06 12at4 38 53PM Pn"
  title="Screenshot2025 06 12at4 38 53PM Pn"
  style={{ width:"69%" }}
/>
...
- **Name**: What you'll call this setting internally (users won't see this)
- **Type**: Choose from text, dropdown, number, or other input types
- **Description**: Instructions that help users understand what to provide
- **Default Value**: Pre-fill common answers to make onboarding faster
- **Help URL**: Link to additional explanation if needed
- **Required**: Whether users must provide this information to continue
...
Once you've set up personalization, new users will see these questions during their onboarding. They can update their preferences anytime in their account settings, and the changes will immediately affect how your agent responds to them.
...
<Note>
  Reference settings in your Behavior by adding Settings to the top of your instructions.
</Note>

Remember: The goal is to make your agent feel like it truly knows each user personally\!