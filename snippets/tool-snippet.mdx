<AccordionGroup>
  ...
  <Accordion title="Amazon Product Search " icon="amazon">
    ...
    Amazon Product Search finds products across Amazon's massive catalog, showing your agent prices, ratings, reviews, and availability. Think of it as having a personal shopper who can instantly scan millions of products, compare prices, read thousands of reviews, and identify the best options based on quality, value, and user needs.

    ### **Why you'd use it** 

    Online shopping means drowning in choices - countless brands, varying prices, conflicting reviews, flash sales. Instead of your users spending hours researching products, reading reviews, and comparing prices across tabs, your agent can search comprehensively, analyze ratings and feedback, and recommend the best options with clear reasoning.

    ### **Suggested use cases**

    - Shopping assistants - Help users find products matching specific needs and budgets
    - Price comparison agents - Track prices across products and identify best values
    - Gift recommendation agents - Suggest thoughtful gifts based on interests and price range
    - Deal finder agents - Monitor sales, lightning deals, and limited-time offers
    - Product research agents - Analyze reviews and ratings to surface quality options
    - Smart shopping list builders - Find best options for recurring purchases
    - Purchase decision helpers - Compare features, prices, and reviews for informed buying

    ### **Real-world scenario** 

    Imagine you're an e-commerce consultant who created an agent called 'Smart Shopper.' A busy parent asks: 'I need educational toys for my 5-year-old's birthday, around \$50 total, something that'll keep her engaged and help with learning.'

    Your agent uses Amazon Product Search to find highly-rated educational toys in the target age range, filters for 4+ star ratings with hundreds of reviews, identifies STEM toys and puzzles within budget, compares prices and Prime delivery options, and presents 3 perfect gift bundles with reasoning like "Parents say this puzzle kept their kids engaged for hours" - turning overwhelming shopping into a confident purchase decision in minutes.
  </Accordion>
</AccordionGroup>