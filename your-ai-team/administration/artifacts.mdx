...
<Frame>
  ![Artifacts grid view showing a library of files produced by agent tasks](/images/artifacts-grid.png)
</Frame>
...
<Frame>
  ![Artifact file detail dialog with preview, actions, and navigation](/images/artifact-detail-dialog.png)
</Frame>
...
<Frame>
  ![Making an artifact public and copying its share link](/images/artifact-share-public.png)
</Frame>
...
<Frame>
  ![Copying an artifact to Knowledge with the folder picker open](/images/artifact-copy-to-knowledge.png)
</Frame>
