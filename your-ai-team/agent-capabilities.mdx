...
<CardGroup cols={2}>
  ...
  <Card title="Document Creation" icon="file" href="/your-ai-team/agent-capabilities/document-creation">
    Real files your agents produce — presentations, spreadsheets, Word docs, PDFs, and images you can download and share.
  </Card>

  <Card title="Why an Automation Stopped Running" icon="triangle-exclamation" href="/your-ai-team/agent-capabilities/connection-health">
    What "Needs reconnection" or "Auto-paused" means, and how to get a schedule running again.
  </Card>
</CardGroup>
