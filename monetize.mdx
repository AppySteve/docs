...
**Platform Fee**: AppyAI takes a 10% fee on each transaction to cover platform costs and ongoing support.

## Setting Your Pricing

Configure exactly how you want to charge for access to your agent.

![Screenshot2025 06 12at5 03 11PM Pn](/images/Screenshot2025-06-12at5.03.11PM.png)
...
Track all incoming payments from your customers, including subscription renewals, trial conversions, and any failed payments that need attention.

### Payouts

Monitor your earnings and payout schedule. See your total balance, available funds, and when your next payout is scheduled. Payments are automatically transferred to your bank account on a regular schedule.

### Pricing

Adjust your subscription rates, trial periods, and pricing strategy as your business grows.

### Documents

Access invoices, tax documents, and other financial records for your business accounting needs.

### Taxes

Manage tax information and compliance requirements based on your location and business structure.

### Account

Update your business details, banking information, and account settings for payment processing.

[IMAGE: Screenshot showing the various monetization management sections]
